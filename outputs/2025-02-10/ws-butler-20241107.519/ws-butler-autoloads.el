...
`(lambda nil Enable `ws-butler-mode' unless current major mode is exempt. (unless (apply (function derived-mode-p) ws-butler-global-exempt-modes) (ws-butler-mode)))' would do it.
